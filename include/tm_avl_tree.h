...
#include<tm_common.h>
#include<tm_stack.h>
typedef struct __tm_avl_tree_node
{
void *ptr;
struct __tm_avl_tree_node *right;
struct __tm_avl_tree_node *left;
}AVLTreeNode;
typedef struct __tm_avl_tree
{
struct __tm_avl_tree_node *start;
int (*predicate)(void *,void *);
int size;
}AVLTree;
typedef struct __tm_avl_tree_in_order_iterator
{
AVLTreeNode *node;
Stack *stack;
}AVLTreeInOrderIterator;
typedef struct __tm_avl_tree_pre_order_iterator
{
AVLTreeNode *node;
Stack *stack;
